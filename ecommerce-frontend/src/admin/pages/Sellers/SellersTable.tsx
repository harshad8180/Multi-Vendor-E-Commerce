...
const accountStatuses = [
  ...
  { status: "ACTIVE", title: "Active", description: "Account is " },
  { status: "SUSPENDED", title: "Suspended", description: "Account is " },
  { status: "DEACTIVATED", title: "Deactivated", description: "Account is " },
  { status: "BANNED", title: "Banned", description: "Account is " },
  { status: "CLOSED", title: "Closed", description: "Account is " },
];
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Acount Status</StyledTableCell>
